...
PORT = "/dev/serial0"  # raspberry pi port that is mapped to handle the shield
        ...
        if lolas_interface.current_mode == 2:  # ENABLED
            ...
            if guidance_step == "INIT":
                ...
                while not (waypoint_reached and stability_counter >= 30) and drone.check_heart_beat():
                    ...
                    setpoint_vx = 0
                    setpoint_vy = 0
                    setpoint_vz = 0 # added becuase sean said
                    setpoint_yaw = 0
                    ...
                    ####### dexter
                    #print(setpoint_vx,",",setpoint_vy,",", setpoint_vz,",", setpoint_yaw," :)")
                    #print(lolas_interface.lolas_yaw)
                    print(lolas_interface.lolas_x, " , ", lolas_interface.lolas_y, " , ", lolas_interface.lolas_yaw, "     :(")
